// 心理健康状态综合自测题（抑郁·焦虑·人际关系敏感版）完整JS数据
const mentalHealthTest = {
  // 测试基础信息
  testInfo: {
    name: '心理健康状态综合自测题',
    subtitle: '抑郁·焦虑·人际关系敏感版',
    totalQuestions: 32,
    timeLimit: '10分钟',
    description:
      '请仔细阅读题目，根据最近一周之内这些情况对你影响的实际感觉，选择最符合的一项。本测试主要对抑郁、焦虑、人际关系敏感症状进行简单评估，仅作趣味参考，不构成专业诊断，若存在明显困扰，建议寻求专业心理支持。'
  },
  // 评分规则
  scoreRule: {
    ...
    dimensions: [
      {
        ...
        scoreLevels: [
          ...
          },
          {
            range: [23, 33],
            level: '轻微抑郁倾向',
            desc: '偶尔出现情绪低落等表现，可自我调节'
          },
          {
            range: [34, 44],
            level: '明显抑郁倾向',
            desc: '持续被负面情绪困扰，需重视并干预'
          }
        ]
      },
      {
        ...
        scoreLevels: [
          ...
          },
          {
            range: [23, 33],
            level: '轻微焦虑倾向',
            desc: '偶尔出现紧张担忧，可通过自我调节缓解'
          },
          {
            range: [34, 44],
            level: '明显焦虑倾向',
            desc: '频繁出现焦虑症状，影响正常生活'
          }
        ]
      },
      {
